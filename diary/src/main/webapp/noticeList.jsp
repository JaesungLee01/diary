...
<%
	...
	*/
	...
	// 자료구조 ResultSet타입을 일반적인자료구조타입(자바 배열 or 기본API 자료구조타입 List, Set, Map)
...
<div class="container">
	...
	<a href="./insertNoticeForm.jsp" class="btn btn-default">공지입력</a>
	...
	<%
		if(currentPage > 1) {
	%>
			<a href="./noticeList.jsp?currentPage=<%=currentPage-1%>" class="btn btn-default">이전</a>
	<%		
		}
	%>
			<%=currentPage%>
	...
	%>
			<a href="./noticeList.jsp?currentPage=<%=currentPage+1%>" class="btn btn-default">다음</a>
	<%
		}
	%>
	</div>
